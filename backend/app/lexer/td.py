...
STATES = {
    ...
    5: State('s', [6]),   6: State('t', [7]),   7: State('e', [8]), 8: State('r', [9]),  9: State(REGDEF['free_delim'], end = True),
    10: State('b', [11]), 11: State('l', [12]), 12: State('a', [13]), 13: State('z', [14]), 14: State('e', [15]), 15: State(REGDEF['free_delim'], end = True),
    16: State('c', [17]), 17: State('o', [18]), 18: State('s', [19]), 19: State(REGDEF['free_delim'], end = True),
    20: State('f', [21]), 21: State('l', [22]), 22: State('u', [23]), 23: State('x', [24]), 24: State(REGDEF['free_delim'], end = True),
    25: State('h', [26]), 26: State('u', [27]), 27: State('b', [28]), 28: State('b', [29]), 29: State('l', [30]), 30: State('e', [31]), 31: State(REGDEF['free_delim'], end = True),
    32: State('i', [33, 37]), 
    33: State('r', [34]), 34: State('i', [35]), 35: State('s', [36]), 36: State(DELIMS['iris_sage_delim'], end = True),
    37: State('x', [38]), 38: State('i', [39]), 39: State('o', [40]), 40: State('n', [41]), 41: State(REGDEF['free_delim'], end = True),
    42: State('k', [43]),     43: State('a', [44]), 44: State('i', [45]), 45: State(REGDEF['free_delim'], end = True),
    46: State('l', [47, 51, 56]), 
    47: State('a', [48]),     48: State('n', [49]), 49: State('i', [50]), 50: State(REGDEF['free_delim'], end = True),
    51: State('e', [52, 54]), 
    52: State('o', [53]), 53: State(REGDEF['free_delim'], end = True),
    54: State('t', [55]), 55: State(REGDEF['free_delim'], end = True),
    56: State('u', [57, 65]), 
    57: State('m', [58, 61]), 
    58: State('e', [59]), 59: State('n', [60]), 60: State(REGDEF['io_delim'], end = True),
    61: State('i', [62]), 62: State('n', [63]), 63: State('a', [64]), 64: State(REGDEF['io_delim'], end = True),
    65: State('n', [66]), 66: State('a', [67]), 67: State(DELIMS['separator_delim'], end = True),
    68: State('m', [69]), 69: State('o', [70]),     70: State('s', [71]), 71: State(REGDEF['free_delim'], end = True),
    72: State('n', [73]), 73: State('o', [74, 76]), 74: State('t', [75]), 75: State(DELIMS['separator_delim'], end = True),
                                                    76: State('v', [77]), 77: State('a', [78]), 78: State(REGDEF['io_delim'], end = True),
    79: State('o', [80]), 80: State('r', [81, 82]), 81: State(DELIMS['separator_delim'], end = True),
                                                    82: State('b', [83]), 83: State('i', [84]), 84: State('t', [85]), 85: State(REGDEF['free_delim'], end = True),
    86: State('p', [87]), 87: State('h', [88]), 88: State('a', [89]), 89: State('s', [90]), 90: State('e', [91]), 91: State(REGDEF['free_delim'], end = True),
    92: State('s', [93, 97, 103, 110]),  
    93: State('a', [94]),   94: State('g', [95]), 95: State('e', [96]), 96: State(DELIMS['iris_sage_delim'], end = True),
    97: State('e', [98]),   98: State('l', [99]), 99: State('e', [100]), 100: State('n', [101]), 101: State('e', [102]), 102: State(REGDEF['free_delim'], end = True),
    103: State('o', [104]), 104: State('l', [105, 106]), 105: State(DELIMS['separator_delim'], end = True),
                                                         106: State('u', [107]), 107: State('n', [108]), 108: State('a', [109]), 109: State(DELIMS['separator_delim'], end = True),
    110: State('t', [111]), 111: State('a', [112]), 112: State('r', [113]), 113: State(REGDEF['free_delim'], end = True),
    114: State('v', [115]), 115: State('o', [116]), 116: State('i', [117]), 117: State('d', [118]), 118: State(REGDEF['free_delim'], end = True),
    119: State('w', [120]), 120: State('a', [121, 124, 127]), 121: State('n', [122]), 122: State('e', [123]), 123: State(DELIMS['separator_delim'], end = True),
                                                              124: State('r', [125]), 125: State('p', [126]), 126: State(DELIMS['warp_delim'], end = True),
                                                              127: State('x', [128]), 128: State(REGDEF['free_delim'], end = True),
    129: State('z', [130, 134]), 130: State('a', [131]), 131: State('r', [132]), 132: State('a', [133]), 133: State(DELIMS['zara_delim'], end = True),
                                 134: State('e', [135]), 135: State('r', [136]), 136: State('u', [137]), 137: State(DELIMS['zeru_delim'], end = True),
    138: State('+', [139, 140, 142]), 
    139: State(DELIMS['arithmetic_delim'], end = True),
    140: State('+', [141]), 
    141: State(DELIMS['unary_delim'], end = True),
    142: State('=', [143]), 
    143: State(DELIMS['most_symbol_delim'], end = True),
    ...
    210: State(REGDEF['digit'], [211, 212, 240]), 211: State(DELIMS['most_data_type_delim'], end = True),
        212: State(REGDEF['digit'], [213, 214, 240]), 213: State(DELIMS['most_data_type_delim'], end = True),
                214: State(REGDEF['digit'], [215, 216, 240]), 215: State(DELIMS['most_data_type_delim'], end = True),
                    216: State(REGDEF['digit'], [217, 218, 240]), 217: State(DELIMS['most_data_type_delim'], end = True),
                        218: State(REGDEF['digit'], [219, 220, 240]), 219: State(DELIMS['most_data_type_delim'], end = True),
                            220: State(REGDEF['digit'], [221, 222, 240]), 221: State(DELIMS['most_data_type_delim'], end = True),
                                222: State(REGDEF['digit'], [223, 224, 240]), 223: State(DELIMS['most_data_type_delim'], end = True),
                                    224: State(REGDEF['digit'], [225, 226, 240]), 225: State(DELIMS['most_data_type_delim'], end = True),
                                        226: State(REGDEF['digit'], [227, 228, 240]), 227: State(DELIMS['most_data_type_delim'], end = True),
                                            228: State(REGDEF['digit'], [229, 230, 240]), 229: State(DELIMS['most_data_type_delim'], end = True),
                                                230: State(REGDEF['digit'], [231, 232, 240]), 231: State(DELIMS['most_data_type_delim'], end = True),
                                                    232: State(REGDEF['digit'], [233, 234, 240]), 233: State(DELIMS['most_data_type_delim'], end = True),
                                                        234: State(REGDEF['digit'], [235, 236, 240]), 235: State(DELIMS['most_data_type_delim'], end = True),
                                                            236: State(REGDEF['digit'], [237, 238, 240]), 237: State(DELIMS['most_data_type_delim'], end = True),
                                                                238: State(REGDEF['digit'], [239]), 239: State(DELIMS['most_data_type_delim'], end = True),
    240: State('.', [241]),
